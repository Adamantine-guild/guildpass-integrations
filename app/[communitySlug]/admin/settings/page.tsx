...
export default function SettingsPage() {
  ...
  const updateConfigMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      addToast({ title: "Configuration saved", description: "Approval thresholds have been updated.", variant: "success" });
    },
    onError: () => {
      addToast({ title: "Error", description: "Failed to update configuration.", variant: "destructive" });
    }
  });
